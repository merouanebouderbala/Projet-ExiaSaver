...
fichier = fopen ("/home/merouane/Desktop/Exia-saver/Term-saver1/1.pbm","r"); // si le nombre aleatoire = 1  le pbm ouvert sera le 1.pbm

else if (nombre_aleatoire == 2)
{
fichier = fopen ("/home/merouane/Desktop/Exia-saver/Term-saver1/2.pbm","r"); // si le nombre aleatoire = 2  le pbm ouvert sera le 2.pbm
}
else if (nombre_aleatoire == 3)
{
fichier = fopen ("/home/merouane/Desktop/Exia-saver/Term-saver1/3.pbm","r"); // si le nombre aleatoire = 3  le pbm ouvert sera le 3.pbm
}
...
{
fichier = fopen ("/home/merouane/Desktop/Exia-saver/Term-saver1/5.pbm","r");// si le nombre aleatoire = 5 le pbm ouvert sera le 5.pbm
}
else if (nombre_aleatoire == 6)
{
fichier = fopen ("/home/merouane/Desktop/Exia-saver/Term-saver1/6.pbm","r");// si le nombre aleatoire = 6  le pbm ouvert sera le 6.pbm
}
...
FILE *fs = NULL;
fs = fopen("/home/merouane/Desktop/Exia-saver/log.txt","a+"); // Ajouter le parametre du Term-saver1 au Log
fprintf(fs,"%d.pbm\n",nombre_aleatoire);
fclose(fs);
